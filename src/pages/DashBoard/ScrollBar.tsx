...
export function SocialScrollBar() {
  return (
    <div className={'flexbox-vertical-container'}>
      <h1 style={{ color: 'white', fontFamily: 'OpenDyslexic3' }}> Social Links </h1>
      <div className={'flexbox-container'} style={{ width: '100vw', textAlign: 'center', justifyContent: 'left' }}>
        <div>
          <a target="_blank" rel="noreferrer" href="https://twitter.com/AnimeVerseToken?t=kruSfQkxcFg6fBXgmFGx6A&s=09">
