          ...
          <div className={'flexbox-vertical-container'} style={{ width: '100vw' }}>
            ...
            <FAQCard onClick={toggleHidden2}>
              ...
              {!isHidden2 && (
                ...
                >
                  {' '}
                  We are a transparent team with a KYC in process. Additionally, we have a Multi-Sig marketing wallet
                  that requires multiple approvals for any transaction to take place. This means no team member can run
                  a transaction solely, ensuring community and project funds are %100 safe.
                </p>
              )}
            </FAQCard>
